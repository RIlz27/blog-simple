...
<body>
    ...
    <div class="bg-white flex justify-between items-center m-10">
        ...
        <div class="flex space-x-4 items-center text-sm text-black justify-end-safe">
            <a href="https://github.com/RIlz27" target="_blank" class="hover:text-gray-500 mr-px">
                <i class="fab fa-github fa-lg"></i>
            </a>
            <a href="https://instagram.com/rilz.jhr" target="_blank" class="hover:text-pink-500 mr-px">
                <i class="fab fa-instagram fa-lg"></i>
            </a>
            <a href="http://my-portfolio-ten-zeta-38.vercel.app" class="hover:text-blue-500 mr-px">
            ...
            <div class="flex items-center space-x-4 bg-white px-4 py-3 mx-5 justify-center" x-data="{ open: false }">
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    ...
                    <div x-show="open" x-transition
                        class="absolute left-0 mt-2 w-40 bg-white rounded shadow-lg z-50 py-1" style="display: none">
                ...
                <a href="{{ route('posts.create') }}"
                    class="text-black focus:text-blue-950 text-base font-semibold">Buat
                    Postingan</a>
            </div>
        </div>
    </nav>
